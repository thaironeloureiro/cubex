...
sonar-scanner   -Dsonar.organization=thaironeloureiro   -Dsonar.projectKey=thaironeloureiro_cubex   -Dsonar.sources=sniffer_cube   -Dsonar.cfamily.build-wrapper-output=build  -Dsonar.host.url=https://sonarcloud.io
