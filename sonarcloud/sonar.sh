...
sonar-scanner   -Dsonar.organization=thaironeloureiro   -Dsonar.projectKey=thaironeloureiro_cubex   -Dsonar.sources=build   -Dsonar.cfamily.build-wrapper-output=build  -Dsonar.host.url=https://sonarcloud.io
